...
For the `to` path, you can specify either an absolute path, a <!--[partial URL descriptor](../routes-segments-urls/#url-descriptors)-->partial URL descriptor, or a getter function that returns either of these.
